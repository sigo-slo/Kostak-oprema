...
public class NotificationHelper extends ContextWrapper {
    ...
    public NotificationHelper(Context base) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel
                    mChannel = new NotificationChannel(CHANNEL_ID, "Sporočilo channel", NotificationManager.IMPORTANCE_LOW);
            mChannel.setDescription("Set Description");
    ...
    public void showNotification(String content, String apkUrl) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(this, 0, myIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private NotificationCompat.Builder getNofity(String text) {
        return new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                ...
                .setContentTitle("Prenašanje posodobitev aplikacije Kostak d.d....")
                .setContentText(text)
